...
parallel::clusterSetRNGStream(cluster, 6)
...
save(estimates, file = "estimates_seed_6.Rdata")
...
pdf(file="cifp_initial_bootstraps.pdf")
...
hist(estimates[,2],
     main = "Histogram of point estimates from IPTW estimator over B bootstrapped samples", 
     xlab="Point Estimates")

hist(estimates[,3], 
     main="Histogram of point estimates from IPTW HT over B bootstrapped samples", 
     xlab="Point Estimates")

hist(estimates[,4], 
     main="Histogram of point estimates from TMLE over B bootstrapped samples", 
     xlab="Point Estimates")
dev.off()
...
hist(estimates[,5], 
     main="Histogram of point estimates from IPTW truncated to gn 0.025, 0.975 over B bootstrapped samples", 
     xlab="Point Estimates")

hist(estimates[,6], 
     main="Histogram of point estimates from IPTW truncated to gn 0.05, 0.95 over B bootstrapped samples", 
     xlab="Point Estimates")

hist(estimates[,7], 
     main="Histogram of point estimates from IPTW truncated to gn 0.10, 0.90 over B bootstrapped samples", 
     xlab="Point Estimates")

hist(estimates[,8], 
     main="Histogram of point estimates from TMLE truncated to gn 0.025, 0.975 over B bootstrapped samples", 
     xlab="Point Estimates")
