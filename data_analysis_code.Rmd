...
make_density_curve <- function(data,variable,xlab,ylab,title,line.at) {
  p <- ggplot(data, aes(x=data[,variable])) + 
    ...
    geom_vline(aes(xintercept=line.at),color="blue", linetype="dashed", size=1) +
...
make_density_curve(estimates_all_x100,"SimpSubs","Estimates","Density","",line.at=0.40)
