...
carb_2016_daily_monitors <- 
   GET(download, query = values_daily_2016)

# write the 2016 daily monitor list to disk
writeBin(content(carb_2016_daily_monitors, "raw"), 
         file.path(
           "raw_data", 
...
carb_2016_hourly_monitors <- 
   GET(download, query = values_hourly_2016)

# write the 2016 hourly monitor list to disk
writeBin(content(carb_2016_hourly_monitors, "raw"), 
         file.path(
           "raw_data", 
...
carb_2016_daily_monitors_working <- 
  monitor_csv_to_tibble_reader(carb_2016_daily_monitors_raw)
carb_2016_hourly_monitors_working <- 
  monitor_csv_to_tibble_reader(carb_2016_hourly_monitors_raw)
