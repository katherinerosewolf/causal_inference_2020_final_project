...
if(!file.exists(file.path("raw_data", 
                          "GWRwSPEC_PM25_NA_201701_201712-RH35.nc"))) {

  download.file(
    url = "http://fizz.phys.dal.ca/~atmos/datasets/EST2019/GWRwSPEC_PM25_NA_201701_201712-RH35.nc", 
    destfile = 
      file.path(
        "raw_data", 
        "GWRwSPEC_PM25_NA_201701_201712-RH35.nc"
...
if(!file.exists(file.path("raw_data", 
                          "GWRwSPEC_PM25_NA_201701_201712-RH35-NoNegs.asc.zip"))) {
  
  download.file(
    url = "http://fizz.phys.dal.ca/~atmos/datasets/EST2019/GWRwSPEC_PM25_NA_201701_201712-RH35-NoNegs.asc.zip", 
    destfile = 
      file.path(
        "raw_data", 
        "GWRwSPEC_PM25_NA_201701_201712-RH35-NoNegs.asc.zip"
...
# join school and latitude/longitude, remove those without one (FIX)
...
plot(school_lat_long_2015_16_sf)
...
```{r compare epa and carb monitors}
...
```{r plot monitor locations, air pollution, schools, and combine}
...
school_lat_long_2016_17_sf$modeled_air_at_school <- 
  raster::extract(
    air_cropped,
    school_lat_long_2016_17_sf
  )
...
# make plot
plot(school_lat_long_2016_17_sf["modeled_air_at_school"], pch=16, cex=0.4)

# plot all 3!
plot(air_cropped)
plot(school_lat_long_2016_17_sf, pch=16, cex=0.2, alpha = 0.8, col="black", add=TRUE)
plot(all_monitors_no_duplicates_sf, pch=16, cex=0.2, col="red", add=TRUE)

nrow(school_lat_long_2016_17_sf)
nrow(all_monitors_no_duplicates_sf)
