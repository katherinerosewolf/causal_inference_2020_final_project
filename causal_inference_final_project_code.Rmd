...
```{r read and save teacher credential data}
...
```{r read and save school fte data}
...
school_teacher_fte <- 
  ...
  group_by(cds_code) %>% 
  summarise(fte_school = sum(fte)) %>% 
  mutate(teachers = fte_school/40)
...
full_data <- 
  ...
  select(-c(district_from_expense_per_pupil, 
...
save(analysis_bare_bones, 
     file = file.path("intermediate_data", 
                      "analysis_bare_bones.rdata"))
...
sum(is.na(dataset_full$overall_standard_met))
sum(is.na(dataset_full$percent_afr_am))
sum(is.na(dataset_full$percent_aian))
sum(is.na(dataset_full$percent_asian))
sum(is.na(dataset_full$percent_filipino))
sum(is.na(dataset_full$percent_hispanic_latino))
sum(is.na(dataset_full$percent_pacific_islander))
sum(is.na(dataset_full$percent_white))
sum(is.na(dataset_full$percent_two_plus))
sum(is.na(dataset_full$percent_not_reported))
...
schools_exposure_some_outcome <- 
  dataset_full %>% 
  filter(!(is.na(english_standard_met) & 
           is.na(science_standard_met) & 
           is.na(math_standard_met)))

# check NA counts
sum(is.na(schools_exposure_some_outcome$overall_standard_met))
sum(is.na(schools_exposure_some_outcome$pm25_12_plus))
sum(is.na(schools_exposure_some_outcome$modeled_air_at_school))
sum(is.na(schools_exposure_some_outcome$air_district))
sum(is.na(schools_exposure_some_outcome$air_basin))

sum(is.na(schools_exposure_some_outcome$overall_standard_met))
sum(is.na(schools_exposure_some_outcome$percent_afr_am))
sum(is.na(schools_exposure_some_outcome$percent_aian))
sum(is.na(schools_exposure_some_outcome$percent_asian))
sum(is.na(schools_exposure_some_outcome$percent_filipino))
sum(is.na(schools_exposure_some_outcome$percent_hispanic_latino))
sum(is.na(schools_exposure_some_outcome$percent_pacific_islander))
sum(is.na(schools_exposure_some_outcome$percent_white))
sum(is.na(schools_exposure_some_outcome$percent_two_plus))
sum(is.na(schools_exposure_some_outcome$percent_not_reported))

sum(is.na(schools_exposure_some_outcome$english_learner_percent))
sum(is.na(schools_exposure_some_outcome$frpm_percent))
sum(is.na(schools_exposure_some_outcome$district_cost_per_pupil))
sum(is.na(schools_exposure_some_outcome$student_teacher_ratio))
sum(is.na(schools_exposure_some_outcome$english_standard_met))
sum(is.na(schools_exposure_some_outcome$math_standard_met))
sum(is.na(schools_exposure_some_outcome$science_standard_met))

# keep only those with all 3 exam results
dataset_complete_outcome <- 
  schools_with_enrollment %>% 
  filter(!is.na(overall_standard_met))

nrow(dataset_complete_outcome)

# check NA counts
sum(is.na(dataset_complete_outcome$overall_standard_met))
sum(is.na(dataset_complete_outcome$pm25_12_plus))
sum(is.na(dataset_complete_outcome$modeled_air_at_school))
sum(is.na(dataset_complete_outcome$air_district))
sum(is.na(dataset_complete_outcome$air_basin))

sum(is.na(dataset_complete_outcome$overall_standard_met))
sum(is.na(dataset_complete_outcome$percent_afr_am))
sum(is.na(dataset_complete_outcome$percent_aian))
sum(is.na(dataset_complete_outcome$percent_asian))
sum(is.na(dataset_complete_outcome$percent_filipino))
sum(is.na(dataset_complete_outcome$percent_hispanic_latino))
sum(is.na(dataset_complete_outcome$percent_pacific_islander))
sum(is.na(dataset_complete_outcome$percent_white))
sum(is.na(dataset_complete_outcome$percent_two_plus))
sum(is.na(dataset_complete_outcome$percent_not_reported))

sum(is.na(dataset_complete_outcome$english_learner_percent))
sum(is.na(dataset_complete_outcome$frpm_percent))
sum(is.na(dataset_complete_outcome$district_cost_per_pupil))
sum(is.na(dataset_complete_outcome$student_teacher_ratio))
sum(is.na(dataset_complete_outcome$english_standard_met))
sum(is.na(dataset_complete_outcome$math_standard_met))
sum(is.na(dataset_complete_outcome$science_standard_met))
...
# check NA counts
sum(is.na(dataset_complete_cases$overall_standard_met))
sum(is.na(dataset_complete_cases$pm25_12_plus))
sum(is.na(dataset_complete_cases$modeled_air_at_school))
sum(is.na(dataset_complete_cases$air_district))
sum(is.na(dataset_complete_cases$air_basin))

sum(is.na(dataset_complete_cases$overall_standard_met))
sum(is.na(dataset_complete_cases$percent_afr_am))
sum(is.na(dataset_complete_cases$percent_aian))
sum(is.na(dataset_complete_cases$percent_asian))
sum(is.na(dataset_complete_cases$percent_filipino))
sum(is.na(dataset_complete_cases$percent_hispanic_latino))
sum(is.na(dataset_complete_cases$percent_pacific_islander))
sum(is.na(dataset_complete_cases$percent_white))
sum(is.na(dataset_complete_cases$percent_two_plus))
sum(is.na(dataset_complete_cases$percent_not_reported))

sum(is.na(dataset_complete_cases$english_learner_percent))
sum(is.na(dataset_complete_cases$frpm_percent))
sum(is.na(dataset_complete_cases$district_cost_per_pupil))
sum(is.na(dataset_complete_cases$student_teacher_ratio))
sum(is.na(dataset_complete_cases$english_standard_met))
sum(is.na(dataset_complete_cases$math_standard_met))
sum(is.na(dataset_complete_cases$science_standard_met))

# number of records in complete cases (8584)
nrow(dataset_complete_cases)
