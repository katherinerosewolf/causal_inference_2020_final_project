...
causal_inference_preliminary_dataset <-
  ...
  mutate(overall_standard_met = round((as.numeric(english_standard_met) + as.numeric(math_standard_met) + as.numeric(science_standard_met))/3, 2))
...
ggplot(data = causal_inference_preliminary_dataset, 
  ...
  ylab("Mean Percentage of Students Met or Exceeded Standard \n(English, Science, and Math) in 2018-19")
