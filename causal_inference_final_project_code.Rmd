...
```{r read and save english and language arts testing data}
...
# unzip the english and language arts testing full data file
unzip(
  zipfile = 
    file.path(
      "raw_data", 
...
colnames(ela_testing_single_data_from_raw)
table(ela_testing_single_data_from_raw$`Subgroup ID`)

write_csv(ela_testing_single_data_from_raw, 
           path = "ela_testing_single_data_from_raw.csv" )

ela_testing_group_data_from_raw <-
  read_csv(file = file.path("intermediate_data",
                            "sb_ca2019_all_csv_v4.txt"))

colnames(ela_testing_group_data_from_raw)
table(ela_testing_group_data_from_raw$`Subgroup ID`)

write_csv(ela_testing_group_data_from_raw, 
           path = "ela_testing_group_data_from_raw.csv" )
...
```{r read and save science testing data}
...
# unzip the science testing full data file
unzip(
  zipfile = 
    file.path(
      "raw_data", 
...
write_csv(science_testing_single_data_from_raw, 
           path = "science_testing_group_data_from_raw.csv" )

science_testing_group_data_from_raw <-
  read_csv(file = file.path("intermediate_data",
                            "cast_ca2019_all_csv_v1.txt"))

write_csv(science_testing_group_data_from_raw, 
           path = "science_testing_group_data_from_raw.csv" )
